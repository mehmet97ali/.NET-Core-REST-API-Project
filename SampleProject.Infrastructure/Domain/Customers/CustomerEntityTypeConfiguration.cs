...
{
    internal sealed class CustomerEntityTypeConfiguration : IEntityTypeConfiguration<Person>
    {
        ...
        {
            builder.ToTable("Persons", SchemaNames.Teams);
            
            builder.HasKey(b => b.Id);

            builder.Property("_surname").HasColumnName("Surname");
            ...
            builder.OwnsMany<Order>(OrdersList, x =>
            {
                ...
                x.ToTable("Orders", SchemaNames.Teams);
                ...
                x.OwnsMany<OrderPlanning>(OrderPlannings, y =>
                {
                    ...
                    y.ToTable("OrderPlannings", SchemaNames.Teams);
